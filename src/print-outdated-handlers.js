 ...
 * @param {{ rows: Array<[string, string, string, string, number|string, string]>, summary: Object, thresholds: Object, vulnMap: Map<string, object>, filterReasonMap: Map<string,string>, excludeMap?: Record<string, string> }} options - Options for JSON output handler.
 ...
 * @param {{ rows: Array<any>, summary: Object, thresholds: Object, vulnMap: Map<string, object>, filterReasonMap: Map<string,string>, excludeMap?: Record<string, string> }} options - Options for XML output handler.
 * @returns {Object} summary object returned from filtering.
 */
 ...
 * @param {{ safeRows: Array<Array>, matureRows: Array<Array>, summary: Object, prodMinAge: number, devMinAge: number, returnSummary: boolean, excludeMap?: Record<string, string> }} options - Options for table output handler.
