...
> Last reviewed: 2026-07-08 **P030 verification pending** — `--update` now reconciles package-lock.json (ADR-0021 / RFC-003); fix shipping via `feat(update)`, awaiting release + user verification.
